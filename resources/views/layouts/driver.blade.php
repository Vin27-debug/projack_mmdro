        ...
        <aside id="driverSidebar" class="sidebar-driver flex-column d-none d-lg-flex">
            ...
            <div class="driver-profile p-3 text-center">
                <div class="driver-avatar mx-auto mb-2"><i class="bi bi-person-fill"></i>
                    <span class="status-dot {{ $onlineClass }}" title="{{ $driverStatusLabel }}"></span>
                </div>
                <div class="driver-name text-white fw-semibold">{{ $driverName }}</div>
                <div class="driver-meta text-white-50 small">
                    @if($driverBadge)<span class="me-2">Badge: {{ $driverBadge }}</span>@endif
                    <span class="badge bg-light text-dark ms-1">{{ $driverStatusLabel }}</span>
                </div>
            </div>
