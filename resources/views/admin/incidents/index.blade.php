        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                <thead class="table-light">
                    <tr><th>Incident No</th><th>Reporter</th><th>Type</th><th>Location</th><th>Status</th><th>Priority</th><th>Actions</th></tr>
                </thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="7" class="text-center text-muted py-4">No incident records found.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
