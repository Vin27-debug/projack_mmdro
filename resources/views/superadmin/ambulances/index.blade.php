...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 mb-4">
    ...
    <a href="{{ route('ambulances.create') }}" class="btn btn-danger">Add Ambulance</a>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <span class="badge bg-secondary">{{ ucfirst($ambulance->status) }}</span>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('ambulances.edit', $ambulance->id) }}" class="btn btn-sm btn-outline-primary">Edit</a>
