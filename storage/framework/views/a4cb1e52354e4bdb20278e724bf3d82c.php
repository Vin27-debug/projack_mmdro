        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold mt-2"><?php echo e($stats['total_vehicles']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold mt-2"><?php echo e($stats['active_vehicles']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold mt-2"><?php echo e($stats['maintenance_vehicles']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold mt-2"><?php echo e($stats['available_vehicles']); ?></div>
                </div>
            </div>
        </div>
    </div>
