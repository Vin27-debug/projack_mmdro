            ...
            <div class="col-12 col-xl-2">
                <aside class="admin-sidebar">
                    ...
                    <nav class="nav flex-column mb-4">
                        ...
                        <a href="<?php echo e(route('admin.audit.logs')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.audit.logs') ? 'active' : ''); ?>">
                            <i class="bi bi-journal-text"></i> Audit Logs
                        </a>
                        <a href="<?php echo e($adminRoute('admin.notifications.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.notifications.*') ? 'active' : ''); ?>">
                            <i class="bi bi-bell"></i> Notifications
                            <span class="badge bg-danger float-end" data-unread-badge><?php echo e($unreadNotifications ?? 0); ?></span>
                        </a>
                        <a href="<?php echo e(url('/admin/incidents')); ?>" class="nav-link <?php echo e(request()->is('admin/incidents*') ? 'active' : ''); ?>">
                            <i class="bi bi-exclamation-triangle"></i> Incidents
                        </a>
                        <a href="<?php echo e($adminRoute('admin.dispatches.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.dispatches.*') ? 'active' : ''); ?>">
                            <i class="bi bi-geo-alt"></i> Dispatch Center
                        </a>
                        <a href="<?php echo e($adminRoute('admin.gps.monitoring')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.gps.monitoring') ? 'active' : ''); ?>">
                            <i class="bi bi-geo-fill"></i> GPS Monitoring
                        </a>
                        <a href="<?php echo e($adminRoute('admin.reports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
                            <i class="bi bi-file-earmark-text"></i> Incident Reports
                        </a>
                        <a href="<?php echo e($adminRoute('admin.reports.pdf.view')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.reports.pdf.view') ? 'active' : ''); ?>">
                            <i class="bi bi-file-earmark-pdf"></i> PDF Reports
                        </a>
                        <a href="<?php echo e($adminRoute('admin.maintenance.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.maintenance.*') ? 'active' : ''); ?>">
                            <i class="bi bi-tools"></i> Vehicle Maintenance
                        </a>
                        <a href="<?php echo e($adminRoute('admin.operations.center')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.operations.center') ? 'active' : ''); ?>">
                            <i class="bi bi-target"></i> Operations Center
                        </a>
                        <a href="<?php echo e($adminRoute('admin.reports.center')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.reports.center') ? 'active' : ''); ?>">
                            <i class="bi bi-graph-up"></i> Reports Center
                        </a>
                        <a href="<?php echo e($adminRoute('admin.reports.response-time')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.reports.response-time') ? 'active' : ''); ?>">
                            <i class="bi bi-stopwatch"></i> Response Time
                        </a>
                    </nav>
                    <form method="POST" action="<?php echo e(route('logout')); ?>" class="px-3 mt-3">
                        <?php echo csrf_field(); ?>
