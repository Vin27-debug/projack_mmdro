        ...
        <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="driverOffcanvas" aria-labelledby="driverOffcanvasLabel">
            ...
            <div class="offcanvas-body p-0">
                ...
                <nav class="nav flex-column p-3">
                    <a href="<?php echo e(route('driver.dashboard')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.dashboard')); ?>"><i class="bi bi-speedometer2 fs-4"></i><span class="label">Dashboard</span></a>
                    <a href="<?php echo e(route('driver.navigation')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.navigation')); ?>"><i class="bi bi-geo-alt-fill fs-4"></i><span class="label">Navigation</span></a>
                    <a href="<?php echo e(route('driver.assignment')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.assignment')); ?>"><i class="bi bi-list-check fs-4"></i><span class="label">My Assignment</span></a>
                    <a href="<?php echo e(route('driver.report.create')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.report.create')); ?>"><i class="bi bi-file-earmark-medical fs-4"></i><span class="label">Reports</span></a>
                    <a href="<?php echo e(route('driver.history')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.history')); ?>"><i class="bi bi-clock-history fs-4"></i><span class="label">Dispatch History</span></a>
                    <a href="<?php echo e(route('driver.settings')); ?>" class="sidebar-link text-dark <?php echo e($isActive('driver.settings')); ?>"><i class="bi bi-gear fs-4"></i><span class="label">Settings</span></a>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="sidebar-link text-dark <?php echo e($isActive('profile.edit')); ?>"><i class="bi bi-person-circle fs-4"></i><span class="label">Profile</span></a>
                </nav>
            </div>
        </div>
