            ...
            <div class="card eoc-card eoc-header-panel p-4 h-100">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto text-end">
                        ...
                        <div class="fs-4 fw-bold mt-1"><?php echo e(now()->format('H:i:s')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card eoc-card p-4 h-100">
                <div class="d-flex align-items-center justify-content-between mb-3 gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="eoc-panel-subtitle mb-0"><?php echo e(auth()->user()->name ?? 'Admin User'); ?></p>
                        </div>
                    </div>
                    <div class="text-end">
                ...
                <div class="row text-center mt-3">
                    <div class="col-6 mb-3">
                        <div class="fs-5 fw-semibold text-white"><?php echo e($incidentCount); ?></div>
                        <div class="text-white-50">Incidents</div>
                    </div>
                    <div class="col-6 mb-3">
                        <div class="fs-5 fw-semibold text-white"><?php echo e($availableDrivers ?? 0); ?></div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-danger h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value" data-counter="activeIncidents"><?php echo e($activeIncidents ?? 0); ?></div>
                                </div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-primary h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value" data-counter="activeDispatches"><?php echo e($activeDispatches ?? 0); ?></div>
                                </div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-info h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value" data-counter="availableVehicles"><?php echo e($availableVehicles ?? 0); ?></div>
                                </div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-success h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value"><?php echo e($activeAmbulances); ?></div>
                                </div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-warning h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value"><?php echo e($responseTime ?? 0); ?>m</div>
                                </div>
                        ...
                        <div class="eoc-kpi-card p-3 border-start border-4 border-secondary h-100">
                            <div class="d-flex align-items-start justify-content-between mb-3 gap-3">
                                <div>
                                    ...
                                    <div class="eoc-kpi-value"><?php echo e($unreadNotifications ?? 0); ?></div>
                                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="fw-semibold text-white"><?php echo e($availableVehicles ?? 0); ?></span>
                            </div>
                            <div class="progress" style="height: 0.5rem;">
                                <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo e(min(($availableVehicles ?? 0) * 10, 100)); ?>%" aria-valuenow="<?php echo e($availableVehicles ?? 0); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="text-white-50">In active response</span>
                                <span class="fw-semibold text-white"><?php echo e($activeAmbulances); ?></span>
                            </div>
                            <div class="progress" style="height: 0.5rem;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo e(min($activeAmbulances * 10, 100)); ?>%" aria-valuenow="<?php echo e($activeAmbulances); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="text-white-50">Under maintenance</span>
                                <span class="fw-semibold text-white"><?php echo e($maintenanceVehicles ?? 0); ?></span>
                            </div>
                            <div class="progress" style="height: 0.5rem;">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo e(min(($maintenanceVehicles ?? 0) * 10, 100)); ?>%" aria-valuenow="<?php echo e($maintenanceVehicles ?? 0); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="text-white-50">Drivers on duty</span>
                                <span class="fw-semibold text-white"><?php echo e($availableDrivers ?? 0); ?></span>
                            </div>
                            <div class="progress" style="height: 0.5rem;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e(min(($availableDrivers ?? 0) * 10, 100)); ?>%" aria-valuenow="<?php echo e($availableDrivers ?? 0); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card eoc-card border-0 shadow-sm rounded-4 overflow-hidden mt-4">
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="fw-semibold"><?php echo e($severityCounts['Fire']); ?></div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="severity-pill severity-medical">Medical</div>
                        <div class="fw-semibold"><?php echo e($severityCounts['Medical']); ?></div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="severity-pill severity-rescue">Rescue</div>
                        <div class="fw-semibold"><?php echo e($severityCounts['Rescue']); ?></div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="severity-pill severity-crime">Crime</div>
                        <div class="fw-semibold"><?php echo e($severityCounts['Crime']); ?></div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="severity-pill severity-other">Other</div>
                        <div class="fw-semibold"><?php echo e($severityCounts['Other']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card eoc-card border-0 shadow-sm rounded-4 chart-card p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between text-white-75 mb-2">
                        ...
                        <span class="fw-semibold"><?php echo e($responseTime ?? 0); ?> minutes</span>
                    </div>
                    <div class="progress" style="height: 0.65rem;">
                        <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo e(min(($responseTime ?? 0) * 2, 100)); ?>%" aria-valuenow="<?php echo e($responseTime ?? 0); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            ...
            <div class="card eoc-card border-0 shadow-sm rounded-4 chart-card p-4">
                ...
                <div class="row text-center g-2 mt-3">
                    <div class="col-6">
                        ...
                        <div class="fw-semibold text-success"><?php echo e($completedDispatches ?? 0); ?></div>
                    </div>
                    <div class="col-6">
                        <div class="text-white-50">In progress</div>
                        <div class="fw-semibold text-primary"><?php echo e($activeDispatches ?? 0); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-7">
            <div class="card eoc-card border-0 shadow-sm rounded-4 p-4 h-100">
                ...
                <?php if(($activePanicAlerts ?? collect())->isNotEmpty()): ?>
                <?php $__currentLoopData = ($activePanicAlerts ?? collect())->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="live-feed-item">
                    <div class="live-feed-title">Panic alert from <?php echo e(optional(optional($alert->driver)->user)->name ?? 'Unknown'); ?></div>
                    <div class="live-feed-text">Coordinates: <?php echo e($alert->latitude ?? 'N/A'); ?>, <?php echo e($alert->longitude ?? 'N/A'); ?> · <?php echo e($alert->triggered_at?->diffForHumans()); ?></div>
                </div>
            ...
            <div class="card eoc-card border-0 shadow-sm rounded-4 p-4 h-100">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless align-middle mb-0 eoc-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = ($operations ?? collect())->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-0 small text-white-50"><?php echo e($activity->created_at?->format('M d, H:i')); ?></td>
                                <td><?php echo e(optional($activity->user)->name ?? 'System'); ?></td>
                                <td class="text-end pe-0"><span class="badge bg-white text-dark"><?php echo e($activity->action ?? 'No action'); ?></span></td>
                            </tr>
...
<script>
    ...
    function loadMapData() {
        ...
        fetch("<?php echo e(route('admin.dashboard.live-command-map')); ?>")
    ...
    function initializeResponseLoadChart() {
        ...
        fetch("<?php echo e(route('admin.dashboard.response-load-analytics')); ?>")
            .then(response => response.json())
            .then(data => {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\muniresq-project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>