            ...
            <div class="col-12 col-xl-2">
                <aside class="super-sidebar">
                    ...
                    <nav class="nav flex-column mb-4">
                        ...
                        <a href="<?php echo e(route('superadmin.drivers')); ?>" class="nav-link <?php echo e(request()->routeIs('superadmin.drivers') ? 'active' : ''); ?>">
                            <i class="bi bi-people"></i> Drivers
                        </a>
                        <a href="<?php echo e(route('ambulances.index')); ?>" class="nav-link <?php echo e(request()->routeIs('ambulances.*') ? 'active' : ''); ?>">
                            <i class="bi bi-truck"></i> Ambulances
                        </a>
                        <a href="<?php echo e(route('backups.index')); ?>" class="nav-link <?php echo e(request()->routeIs('backups.*') ? 'active' : ''); ?>">
                            <i class="bi bi-cloud-arrow-up"></i> Backup & Restore
                        </a>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-3 px-3">
                            <?php echo csrf_field(); ?>
